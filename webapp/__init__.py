    ...
    def add_cors_headers(response):
        ...
        response.headers.setdefault(
            ...
            (
                ...
                "img-src 'self' data: blob: https://prod.spline.design https://*.spline.design https://my.spline.design; "
                "media-src 'self' blob: https://prod.spline.design https://*.spline.design https://my.spline.design"
            ),
        )
